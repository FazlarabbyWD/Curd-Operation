...
if(isset($_POST['save_employee']))
{
    ...
    $query = "INSERT INTO employee (name,email,phone,designation,salary,address) VALUES ('$name','$email','$phone','$designation','$salary','$address')";
...
if(isset($_POST['update_employee']))
{
    ...
    $query = "UPDATE employee SET name='$name', email='$email', phone='$phone', designation='$designation', salary='$salary',address='$address' WHERE id='$employee_id' ";
    $query_run = mysqli_query($con, $query);
